...
namespace Arrival
{
    public class BusStationArrivalAPI
    {
        ...
        //API 클래스 내부에서만 세팅됨
        public List<ArrivalBusData> FindStationInfoByID(int _busStationID, List<ArrivalBusData> arrivalBusDatas)
        {
            List<ArrivalBusData> busDataList = arrivalBusDatas;
        ...
        public List<ArrivalBusData> UpdateStationInfoByID(int _busStationID, List<ArrivalBusData> arrivalBusDatas)
        {

            busDataList = arrivalBusDatas;
            if (_busStationID == -1)
                return busDataList;
        ...
        private void setBusArrivalTimeByBusName(string _routeName, string _message, int _time)
        {
